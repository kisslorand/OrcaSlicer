    ...
    if (viewer != nullptr) {
        ...
        switch (view_type) {
            ...
            case libvgcode::EViewType::ActualSpeed:
                sprintf(detail_buf, "%s%.1f", _u8L("Actual Speed: ").c_str(), vertex.actual_feedrate);
                break;
        ...
        if (ImGui::Button(into_u8(properties_shown ? ImGui::UnfoldButtonIcon : ImGui::FoldButtonIcon).c_str(), ImVec2(fold_button_w, fold_button_w))) {
